...
//
        ...
        lists2.forEach(p3s -> {
            Color r = Color.newCol((float) r(), (float) r(), (float) r());
            double xA;
            double yA;
            p3s.forEach(point3D -> {
                if (isInBound(point3D)) {
        ...
        list3.forEach(p3s -> {
            one.empty3.libs.Color r = Color.newCol((float) r(), (float) r(), (float) r());
            if (p3s.size() > 2) {
                for (int j = 0; j < p3s.size() - 1; j++) {
                    ...
                    for (double i = 0; i < 1.0; i += 1. / length) {
                        ...
                        img3.setValues((int) (double) (point3D.getX()), (int) (double) (point3D.getY()),
                                ...
                                /*        r.red() / 255., r.green() / 255., r.blue() / 255.*/
                        );
                    }
                }
            }
        ...
        for (LineSegment line : lines) {
            if (line.getLength() >= 2) {
                ...
                if (isInBound(pDraw1) && isInBound(pDraw2)) {
                    //bLines.drawLine(x1, y1, x2, y2, Color.random().toArgb());
                }
            }
        }
