...
public class DipSnake /*extends ParametricCurve*/ {
    ...
    public double pointsIn(one.empty3.feature.PixM original) {
        one.empty3.feature.PixM m = new PixM(original.getColumns(), original.getLines());
    ...
    public double energy(one.empty3.feature.PixM image) {
    ...
    public double energyGradient(one.empty3.feature.PixM image) {
        return pointsIn(image);

    }

    /*
        public double energyExt(one.empty3.feature.PixM image) {
            return pointsOut(image);
        }
    */
    public void energyMinimization(one.empty3.feature.PixM image) {
