...
public class Hist1Votes extends ProcessFile {
    ...
    public boolean process(File in, File out) {
        one.empty3.feature.PixM inP = new PixM(Objects.requireNonNull(one.empty3.ImageIO.read(in)));
        one.empty3.feature.PixM outP = new PixM(inP.getColumns(), inP.getLines());
