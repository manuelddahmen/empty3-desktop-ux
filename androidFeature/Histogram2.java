...
public class Histogram2 extends ProcessFile {
    ...
    public boolean process(File in, File out) {
        ...
        one.empty3.feature.PixM imageCoutours = new PixM(one.empty3.ImageIO.read(in));
        ...
        // grouper les points par similarites et distances
              /*  group(pointsOfInterest);
                ...
                File fileToWrite3 = new File(directory.getAbsolutePath()
                        + "level"+ "_NEW_RGB.jpg");
                //fileToWrite.mkdirs();*/
        one.empty3.Image.saveFile(new PixM(img3).normalize(0., 1.).getImage(), "JPEG", out, shouldOverwrite);
                /*
