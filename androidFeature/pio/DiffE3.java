...
class Circle {
    ...
    double x, y, r, a;
    public one.empty3.feature.PixM m;
    Color c;
    double i;

    public Circle(one.empty3.feature.PixM m, double x, double a,
                  double y, double r) {
        this.x = x;
        this.y = y;
        this.r = r;
 ...
 */
    ...
    public boolean process(File in, File out) {
        one.empty3.feature.PixM moutA, moutB;
        try {

            if (!in.getName().endsWith(".jpg"))
                return false;
            one.empty3.feature.PixM pi = new PixM(one.empty3.ImageIO.read(in));
            moutA = pi;
            moutB = pi;
            // work on featutes
