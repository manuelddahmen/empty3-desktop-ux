...
public class MIMmops {
    public static one.empty3.feature.PixM applyMultipleFilters(PixM pixM, int level, FilterPixM... filter) {
    ...
    public M matGrad(one.empty3.feature.PixM image, M3 gradientX, M3 gradientY) {
        M matGrad = null;
        // image :  smoothes
