...
public class SelectPointColorMassAglo extends one.empty3.feature.FilterPixM {
    ...
    public Color getTmpColor() {
        return Color.newCol((tmpColor[0]), (tmpColor[1]), (tmpColor[2]));
    }

    public void setTmpColor(one.empty3.libs.Color tmpColor) {
