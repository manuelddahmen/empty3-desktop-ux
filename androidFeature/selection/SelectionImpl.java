...
public class SelectionImpl extends Selection {
    public List<Point3D> select(List<Point3D> preSelection, one.empty3.feature.PixM pix, int rgb, double threshold) {
    ...
    @Override
    public List<Point3D> selectColorPoint(List<Point3D> preSelection, one.empty3.feature.PixM pix, int rgb,
    ...
    @Override
    public List<Point3D> selectPoint(List<Point3D> preSelection, one.empty3.feature.PixM pix, int x, int y) {
        return null;
    }

    @Override
    public List<Point3D> selectInRect(List<Point3D> preSelection, one.empty3.feature.PixM pix, int x1, int y1, int x2, int y2) {
        return null;
    }
}
