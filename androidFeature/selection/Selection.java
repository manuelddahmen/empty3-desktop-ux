...
public abstract class Selection extends ProcessFile {
    ...
    private one.empty3.feature.PixM image;
    ...
    public List<Point3D> select(List<Point3D> preSelection, one.empty3.feature.PixM pix,
    ...
    public List<Point3D> selectColorPoint(List<Point3D> preSelection, one.empty3.feature.PixM pix,
    ...
    public abstract List<Point3D> selectPoint(List<Point3D> preSelection, one.empty3.feature.PixM pix,
                                              int x, int y);

    public abstract List<Point3D> selectInRect(List<Point3D> preSelection, one.empty3.feature.PixM pix,
