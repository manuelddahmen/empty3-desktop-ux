package one.empty3.androidFeature;//package one.empty3.feature20220726;
//
//import java.io.File;
...
//    private one.empty3.libs.Color toGrayScale(File f) throws Exception {
//        Image img = one.empty3.ImageIO.read(f);
//        Image grey = new one.empty3.libs.Color(img.getWidth(), img.getHeight(), one.empty3.libs.Color.TYPE_BYTE_GRAY);
