...
public class Human extends RepresentableConteneur {
    ...
    public void walking() {
        ...
        one.empty3.library.Move teteBas = new one.empty3.library.Move("humanWalks1", tete.getRepresentable(), "circle,axis,p1",
                0.0, 3.0, new Point3D(distancePas2, 0.0, 0.0));
        one.empty3.library.Move teteHaut = new one.empty3.library.Move("humanWalks2", tete.getRepresentable(), "circle,axis,p2",
                0.0, 3.0, new Point3D(distancePas2, 0.0, 0.0));
        one.empty3.library.Move piedGaucheWalk0 = new one.empty3.library.Move("humanWalks3", piedGauche.getRepresentable(), "soulCurve:0,coefficients:0",
                0.0, 1.5, new Point3D(distancePas2, 0.0, 0.0));
        one.empty3.library.Move piedDroiteWalk0 = new one.empty3.library.Move("humanWalks4", piedDroit.getRepresentable(), "soulCurve:0,coefficients:1",
                0.0, 1.5, new Point3D(distancePas2, 0.0, 0.0));
        one.empty3.library.Move piedGaucheWalk1 = new one.empty3.library.Move("humanWalks5", piedGauche.getRepresentable(), "soulCurve:0,coefficients:0",
                0.0, 1.5, new Point3D(0.0, 0.0, distancePas2));
        one.empty3.library.Move piedDroiteWalk1 = new one.empty3.library.Move("humanWalks6", piedDroit.getRepresentable(), "soulCurve:0,coefficients:1",
                0.0, 1.5, new Point3D(0.0, 0.0, distancePas2));
        one.empty3.library.Move jbg1 = new one.empty3.library.Move("humanWalks7", jambeBasGauche.getRepresentable(), "soulCurve:0,coefficients:0",
                0.0, 1.5, new Point3D(distancePas2, 0.0, 0.0));
        one.empty3.library.Move jbg2 = new one.empty3.library.Move("humanWalks8", jambeBasGauche.getRepresentable(), "soulCurve:0,coefficients:1",
                0.0, 1.5, new Point3D(distancePas2, 0.0, 0.0));
        one.empty3.library.Move jbd1 = new one.empty3.library.Move("humanWalks9", jambeBasDroite.getRepresentable(), "soulCurve:0,coefficients:0",
                0.0, 1.5, new Point3D(distancePas2, 0.0, 0.0));
        one.empty3.library.Move jbd2 = new one.empty3.library.Move("humanWalks10", jambeBasDroite.getRepresentable(), "soulCurve:0,coefficients:1",
                0.0, 1.5, new Point3D(distancePas2, 0.0, 0.0));
        one.empty3.library.Move jhg1 = new one.empty3.library.Move("humanWalks11", jambeHautGauche.getRepresentable(), "soulCurve:0,coefficients:0",
                0.0, 1.5, new Point3D(distancePas2, 0.0, 0.0));
        one.empty3.library.Move jhg2 = new one.empty3.library.Move("humanWalks12", jambeHautGauche.getRepresentable(), "soulCurve:0,coefficients:1",
                0.0, 1.5, new Point3D(distancePas2, 0.0, 0.0));
        one.empty3.library.Move jhd1 = new one.empty3.library.Move("humanWalks13", jambeHautDroite.getRepresentable(), "soulCurve:0,coefficients:0",
                0.0, 1.5, new Point3D(distancePas2, 0.0, 0.0));
        one.empty3.library.Move jhd2 = new one.empty3.library.Move("humanWalks14", jambeHautDroite.getRepresentable(), "soulCurve:0,coefficients:1",
                0.0, 1.5, new Point3D(distancePas2, 0.0, 0.0));
        one.empty3.library.Move bhg1 = new one.empty3.library.Move("humanWalks15", brasHautGauche.getRepresentable(), "soulCurve:0,coefficients:0",
                0.0, 1.5, new Point3D(distancePas2, 0., 0.));
        one.empty3.library.Move bhg2 = new one.empty3.library.Move("humanWalks16", brasHautGauche.getRepresentable(), "soulCurve:0,coefficients:1",
                0.0, 1.5, new Point3D(distancePas2, 0., 0.0));
        one.empty3.library.Move bhd1 = new one.empty3.library.Move("humanWalks17", brasHautDroit.getRepresentable(), "soulCurve:0,coefficients:0",
                0.0, 1.5, new Point3D(distancePas2, 0.0, 0.0));
        one.empty3.library.Move bhd2 = new one.empty3.library.Move("humanWalks18", brasHautDroit.getRepresentable(), "soulCurve:0,coefficients:1",
                0.0, 1.5, new Point3D(distancePas2, 0.0, 0.0));
        one.empty3.library.Move bbg1 = new one.empty3.library.Move("humanWalks19", brasBasGauche.getRepresentable(), "soulCurve:0,coefficients:0",
                0.0, 1.5, new Point3D(distancePas2, 0.0, 0.0));
        one.empty3.library.Move bbg2 = new one.empty3.library.Move("humanWalks20", brasBasDroit.getRepresentable(), "soulCurve:0,coefficients:1",
                0.0, 1.5, new Point3D(distancePas2, 0.0, 0.0));
        one.empty3.library.Move bbd1 = new one.empty3.library.Move("humanWalks21", brasBasGauche.getRepresentable(), "soulCurve:0,coefficients:0",
                0.0, 1.5, new Point3D(distancePas2, 0.0, 0.0));
        one.empty3.library.Move bbd2 = new Move("humanWalks22", brasBasDroit.getRepresentable(), "soulCurve:0,coefficients:1",
                0.0, 1.5, new Point3D(distancePas2, 0.0, 0.0));
