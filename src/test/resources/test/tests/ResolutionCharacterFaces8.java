...
public class ResolutionCharacterFaces8 implements Runnable {
    ...
    private static one.empty3.csv.CsvWriter writer;
    ...
    */
    ...
    public void run() {
        ...
        while (size < Math.max(imageFullSize0.getWidth(), imageFullSize0.getHeight())) {
            ...
            final ITexture texture = new TextureCol(java.awt.Color.BLACK);
    ...
    class State {
        ...
        Color textColor = java.awt.Color.BLACK;
        int dim;
        ...
        public double computeError() {
            ...
            state.currentCurves.forEach(courbeParametriquePolynomialeBezier -> {
                pError.plotCurve(courbeParametriquePolynomialeBezier, new TextureCol(java.awt.Color.BLACK));
                numCurves++;
            });
