...
public class Sunset extends TestObjetSub {
    ...
    public void ginit() {
        super.ginit();
        imageTextureTrunk = new ImageTexture(new Image(ImageIO.read(new File("resources/img/CIMG0454-modif-cs4.jpg"))));
    ...
    public void finit() throws Exception {
        ...
        if (frame() < VUE_1 * FPS) {
            ...
            z().texture(new ColorTexture(java.awt.Color.BLACK));
            polygon = new Plane();
            polygon1 = new Plane();
