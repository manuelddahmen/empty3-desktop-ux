...
class TestStringAnalyzer5 {
    ...
    fun mainTestStringAnalyzer5() {
        val testStringAnalyzer5 = TestStringAnalyzer5()
        testStringAnalyzer5.testReadMultiSources()
    }

    companion object {
        @JvmStatic
        fun main(args: Array<String>) {
            TestStringAnalyzer5().mainTestStringAnalyzer5()
        }
    }
}