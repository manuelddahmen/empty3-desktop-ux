...
import one.empty3.test.tests.Move;
...
public class Human extends RepresentableConteneur {
    ...
    public void init(boolean isMan) {
        ...
        Tubulaire4 tronc2 = new Tubulaire4(new LineSegment(pos().plus(Point3D.Z.mult(hauteurBassin).plus(Point3D.Y.mult(0))),
        ...
        Tubulaire4 bhg = new Tubulaire4(new LineSegment(
        ...
        Tubulaire4 bhd = new Tubulaire4(new LineSegment(
                pos().plus(new Point3D(0.0, -largeurEpaule, hauteurTroncHaut)),
                pos().plus(new Point3D(0.0, -largeurEpaule, hauteurTroncBas))), rayonMembresHaut);
        ...
        Tubulaire4 bbg = new Tubulaire4(new LineSegment(pos().plus(new Point3D(0.0, largeurEpaule, hauteurTroncBas)),
                pos().plus(new Point3D(0.0, largeurEpaule, hauteurBassin))), rayonMembresHaut);
        Tubulaire4 bbd = new Tubulaire4(new LineSegment(
        ...
        Tubulaire4 jhgT = new Tubulaire4(new LineSegment(pos().plus(Point3D.Z.mult(hauteurRotule).plus(Point3D.Y.mult(largeurBassin))),
                pos().plus(Point3D.Z.mult(hauteurBassin).plus(Point3D.Y.mult(largeurBassin)))
        ), rayonMembres);
        Tubulaire4 jhdT = new Tubulaire4(new LineSegment(pos().plus(Point3D.Z.mult(hauteurRotule).plus(Point3D.Y.mult(-largeurBassin))),
                pos().plus(Point3D.Z.mult(hauteurBassin).plus(Point3D.Y.mult(-largeurBassin)))
        ), rayonMembres);
        jambeHautGauche = new Membre(jhgT);
        jambeHautDroite = new Membre(jhdT);
        Tubulaire4 jambeBasG = new Tubulaire4(new LineSegment(pos().plus(Point3D.Z.mult(hauteurCheville).plus(Point3D.Y.mult(largeurBassin))),
                pos().plus(Point3D.Z.mult(hauteurRotule).plus(Point3D.Y.mult(largeurBassin)))
        ), rayonMembres);
        Tubulaire4 jambeBasD = new Tubulaire4(new LineSegment(pos().plus(Point3D.Z.mult(hauteurCheville).plus(Point3D.Y.mult(-largeurBassin))),
                pos().plus(Point3D.Z.mult(hauteurRotule).plus(Point3D.Y.mult(-largeurBassin)))
        ), rayonMembres);
        ...
        Tubulaire4 piedG = new Tubulaire4(new LineSegment(pos().plus(Point3D.Z.mult(hauteurCheville).plus(Point3D.Y.mult(largeurBassin))),
                pos().plus(Point3D.Z.mult(hauteurSol).plus(Point3D.Y.mult(largeurBassin)).plus(Point3D.X.mult(0.2)))), rayonMembres);
        Tubulaire4 piedD = new Tubulaire4(new LineSegment(pos().plus(Point3D.Z.mult(hauteurCheville).plus(Point3D.Y.mult(-largeurBassin))),
                pos().plus(Point3D.Z.mult(hauteurSol).plus(Point3D.Y.mult(-largeurBassin)).plus(Point3D.X.mult(0.2)))), rayonMembres);
    ...
    public void addSexe() {
        ...
        if (man) {
            Tubulaire4 sexe1 = new Tubulaire4(new LineSegment(
    ...
    public void walking() {
        ...
        one.empty3.test.tests.Move teteBas = new one.empty3.test.tests.Move("humanWalks1", tete.getRepresentable(), "circle,axis,p1",
                0.0, 3.0, new Point3D(distancePas2, 0.0, 0.0));
        one.empty3.test.tests.Move teteHaut = new one.empty3.test.tests.Move("humanWalks2", tete.getRepresentable(), "circle,axis,p2",
                0.0, 3.0, new Point3D(distancePas2, 0.0, 0.0));
        one.empty3.test.tests.Move piedGaucheWalk0 = new one.empty3.test.tests.Move("humanWalks3", piedGauche.getRepresentable(), "soulCurve:0,coefficients:0",
                0.0, 1.5, new Point3D(distancePas2, 0.0, 0.0));
        one.empty3.test.tests.Move piedDroiteWalk0 = new one.empty3.test.tests.Move("humanWalks4", piedDroit.getRepresentable(), "soulCurve:0,coefficients:1",
                0.0, 1.5, new Point3D(distancePas2, 0.0, 0.0));
        one.empty3.test.tests.Move piedGaucheWalk1 = new one.empty3.test.tests.Move("humanWalks5", piedGauche.getRepresentable(), "soulCurve:0,coefficients:0",
                0.0, 1.5, new Point3D(0.0, 0.0, distancePas2));
        one.empty3.test.tests.Move piedDroiteWalk1 = new one.empty3.test.tests.Move("humanWalks6", piedDroit.getRepresentable(), "soulCurve:0,coefficients:1",
                0.0, 1.5, new Point3D(0.0, 0.0, distancePas2));
        one.empty3.test.tests.Move jbg1 = new one.empty3.test.tests.Move("humanWalks7", jambeBasGauche.getRepresentable(), "soulCurve:0,coefficients:0",
                0.0, 1.5, new Point3D(distancePas2, 0.0, 0.0));
        one.empty3.test.tests.Move jbg2 = new one.empty3.test.tests.Move("humanWalks8", jambeBasGauche.getRepresentable(), "soulCurve:0,coefficients:1",
                0.0, 1.5, new Point3D(distancePas2, 0.0, 0.0));
        one.empty3.test.tests.Move jbd1 = new one.empty3.test.tests.Move("humanWalks9", jambeBasDroite.getRepresentable(), "soulCurve:0,coefficients:0",
                0.0, 1.5, new Point3D(distancePas2, 0.0, 0.0));
        one.empty3.test.tests.Move jbd2 = new one.empty3.test.tests.Move("humanWalks10", jambeBasDroite.getRepresentable(), "soulCurve:0,coefficients:1",
                0.0, 1.5, new Point3D(distancePas2, 0.0, 0.0));
        one.empty3.test.tests.Move jhg1 = new one.empty3.test.tests.Move("humanWalks11", jambeHautGauche.getRepresentable(), "soulCurve:0,coefficients:0",
                0.0, 1.5, new Point3D(distancePas2, 0.0, 0.0));
        one.empty3.test.tests.Move jhg2 = new one.empty3.test.tests.Move("humanWalks12", jambeHautGauche.getRepresentable(), "soulCurve:0,coefficients:1",
                0.0, 1.5, new Point3D(distancePas2, 0.0, 0.0));
        one.empty3.test.tests.Move jhd1 = new one.empty3.test.tests.Move("humanWalks13", jambeHautDroite.getRepresentable(), "soulCurve:0,coefficients:0",
                0.0, 1.5, new Point3D(distancePas2, 0.0, 0.0));
        one.empty3.test.tests.Move jhd2 = new one.empty3.test.tests.Move("humanWalks14", jambeHautDroite.getRepresentable(), "soulCurve:0,coefficients:1",
                0.0, 1.5, new Point3D(distancePas2, 0.0, 0.0));
        one.empty3.test.tests.Move bhg1 = new one.empty3.test.tests.Move("humanWalks15", brasHautGauche.getRepresentable(), "soulCurve:0,coefficients:0",
                0.0, 1.5, new Point3D(distancePas2, 0., 0.));
        one.empty3.test.tests.Move bhg2 = new one.empty3.test.tests.Move("humanWalks16", brasHautGauche.getRepresentable(), "soulCurve:0,coefficients:1",
                0.0, 1.5, new Point3D(distancePas2, 0., 0.0));
        one.empty3.test.tests.Move bhd1 = new one.empty3.test.tests.Move("humanWalks17", brasHautDroit.getRepresentable(), "soulCurve:0,coefficients:0",
                0.0, 1.5, new Point3D(distancePas2, 0.0, 0.0));
        one.empty3.test.tests.Move bhd2 = new one.empty3.test.tests.Move("humanWalks18", brasHautDroit.getRepresentable(), "soulCurve:0,coefficients:1",
                0.0, 1.5, new Point3D(distancePas2, 0.0, 0.0));
        one.empty3.test.tests.Move bbg1 = new one.empty3.test.tests.Move("humanWalks19", brasBasGauche.getRepresentable(), "soulCurve:0,coefficients:0",
                0.0, 1.5, new Point3D(distancePas2, 0.0, 0.0));
        one.empty3.test.tests.Move bbg2 = new one.empty3.test.tests.Move("humanWalks20", brasBasDroit.getRepresentable(), "soulCurve:0,coefficients:1",
                0.0, 1.5, new Point3D(distancePas2, 0.0, 0.0));
        one.empty3.test.tests.Move bbd1 = new one.empty3.test.tests.Move("humanWalks21", brasBasGauche.getRepresentable(), "soulCurve:0,coefficients:0",
                0.0, 1.5, new Point3D(distancePas2, 0.0, 0.0));
        one.empty3.test.tests.Move bbd2 = new Move("humanWalks22", brasBasDroit.getRepresentable(), "soulCurve:0,coefficients:1",
                0.0, 1.5, new Point3D(distancePas2, 0.0, 0.0));
