...
public class TestBlob extends TestObjetSub {
    ...
    public static void main(String[] args) {
        ...
        th.setGenerate(GENERATE_MOVIE | GENERATE_IMAGE | GENERATE_MODEL | GENERATE_SAVE_IMAGE);
        new Thread(th).start();
    }
    ...
    public void ginit() {
        ...
        blobC.texture(tc);
        scene().add(blobC);
        ColorTexture colorTextureBackground = new ColorTexture(new Color(Color.BLACK));
