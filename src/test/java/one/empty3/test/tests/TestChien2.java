...
public class TestChien2 extends TestObjetSub {
    ...
    public static void main(String[] args) {
        TestChien2 balade1 = new TestChien2();
        balade1.loop(true);
        balade1.setMaxFrames(1000);
...
//Artifact : empty3-library-3d-gui ...
        ...
        tetes.texture(new ColorTexture(Color.newCol(0f,1f,0f)));
        queue.texture(new ColorTexture(Color.newCol(0f,0f,0f)));
...
/*Parallelepiped corps = new Parallelepiped(tete,
   ...
   new Point3D(0.,0.,0.5 ),
        ...
        Tubulaire3 corp;
        corp = new Tubulaire3();
        corp.texture(new ColorTexture(new Color(Color.ORANGE)));
