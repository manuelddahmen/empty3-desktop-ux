...
public class Coque extends RepresentableConteneur {
    ...
    public Coque(Voiture voiture) {
        ...
        add( new Polygon(pointsAccrocheLateraux.getData1d().toArray(gauche), new Color(Color.GRAY)));
        add( new Polygon(pointsAccrocheLateraux.getData1d().toArray(droit), new Color(Color.GRAY)));
    }
}
