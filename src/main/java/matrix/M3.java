...
public class M3 {
    ...
    int incrOK = 0;
    private Logger Log = Logger.getLogger(M3.class.getName());;
    ...
    private void init() {
        try {
            ...
            Log.log(Level.SEVERE, MBitmap.class.toString(), "OutOfMemoryException : M3.init("
                    + columns + "," + lines + ")" + ex.getMessage());
            ex.printStackTrace();
            columns = 1200;
            lines = 120;
            try {
                ...
                try {
                    ...
                    Log.log(Level.SEVERE, MBitmap.class.toString(), "FAILED. OutOfMemoryException : M3.init("
                            + columns + "," + lines + ")" + ex.getMessage());
                    ex.printStackTrace();
                }
            }
