...
import one.empty3.apps.feature.FTPProcessFiles;
import one.empty3.apps.feature.ProcessBean;
...
public class SetSettings {
    ...
    public HashMap<String, one.empty3.apps.feature.ProcessBean> processBeans = new HashMap<>();
                ...
                if (i == 0) {
                    ...
                    if (server.startsWith("ftp")) {
                        ...
                        for (int index1 = 0; index1 < files1.length; index1++) {
                            processBeans.put(directory, new one.empty3.apps.feature.ProcessBean(files1[index1]));
                        }
                    } else {
                        // local path
                        ...
                        for (int d = 0; d < initialDirectories.length; d++)
                            if (new File(initialDirectories[d]).exists()) {
                                ...
                                for (int index1 = 0; index1 < files.length; index1++) {
                                    processBeans.put(directory, new one.empty3.apps.feature.ProcessBean(files[index1]));
                                }
                            }
                    ...
                    if (new File(currentDirin[index]).exists()) {
                        ...
                        for (int index1 = 0; index1 < files.length; index1++) {
                            List<one.empty3.apps.feature.ProcessBean> list1 = new ArrayList<>();
