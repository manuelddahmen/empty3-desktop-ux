...
public class DipSnake extends ParametricCurve {
    ...
    public double pointsIn(PixM original) {
        ...
        m.fillIn(this, new ColorTexture(java.awt.Color.BLACK.getRGB()), new ColorTexture(Color.WHITE.getRGB()));
        double moy = 0.0;
        int countIn = 0;
    ...
    public double pointsOut(M original) {
        ...
        m.fillIn(this, new ColorTexture(Color.WHITE.getRGB()), new ColorTexture(Color.WHITE.getRGB()));
        for (int l = 0; l < original.getLines(); l++)
            for (int c = 0; c < original.getColumns(); c++) {
