...
public class CurveFitting extends ProcessFile {
    one.empty3.apps.feature.CourbeN11 curvePoints;
    /*
     *
     * Morphing
     * Mask
    ...
    */
    public one.empty3.apps.feature.CourbeN11 approx() {
        ...
        p.toArray(point3DS);
        curvePoints = new one.empty3.apps.feature.CourbeN11(point3DS);
        return curvePoints;
    }
    ...
    public boolean process(File in, File out) {
        try {
            ...
            inPix.fillIn(curveInitial, new ColorTexture(Color.WHITE.getRGB()), new ColorTexture(Color.RED.getRGB()));
            outPix.paintAll(new double[]{1, 1, 1});
            outPix.fillIn(curveInitial, new ColorTexture(java.awt.Color.BLACK.getRGB()), new ColorTexture(Color.RED.getRGB()));
            ...
            //inPix.paintAll(new double[]{0, 0, 0});
            //outPix.paintAll(new double[]{1, 1, 1});
            inPix.fillIn(curvePoints, new ColorTexture(Color.WHITE.getRGB()), new ColorTexture(Color.WHITE.getRGB()));
            outPix.fillIn(curvePoints, new ColorTexture(java.awt.Color.BLACK.getRGB()), new ColorTexture(java.awt.Color.BLACK.getRGB()));
            ...
            p.plotCurve(curvePoints, new ColorTexture(Color.WHITE.getRGB()));
            Logger.getAnonymousLogger().log(Level.INFO, "Courbe 5/5");
            p.plotCurve(circle, new ColorTexture(Color.BLUE.getRGB()));
            ...
            //normalize.fillIn(courbeParametriquePolynomialeBezier, java.awt.Color.BLACK, Color.WHITE);
