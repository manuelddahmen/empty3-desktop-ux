        ...
        if (editPanel.image != null && editPanel.model != null) {
            ...
            try {
                if (distanceMap.isAssignableFrom(DistanceProxLinear1.class)) {
                    ...
                    distanceAB = new DistanceProxLinear44_2(lA, lB, lC, new Dimension(editPanel.image.getWidth(), editPanel.image.getHeight()),
                            bDimReal, cDimReal, editPanel.opt1, editPanel.optimizeGrid, new one.empty3.libs.Image(editPanel.imageFileRight));
