...
public class FaceDetectAppHttp implements HttpFunction {
    ...
    public void service(HttpRequest httpRequest, HttpResponse httpResponse) throws Exception {
        try {
            Gson gson = new Gson().fromJson(Reader.nullReader(), Gson.class);
            String inputPath = gson.fromJson("image", String.class);
            byte[] decode = Base64.getDecoder().decode(inputPath);
            ...
            if(inputPath!=null) {
                ...
                app.dataWriter = new PrintWriter(byteArrayOutputStream1);
                ...
                hashMapResponse.put("image", Base64.getEncoder().encodeToString(byteArrayOutputStream1.toString().getBytes()));
