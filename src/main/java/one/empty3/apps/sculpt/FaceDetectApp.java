...
public class FaceDetectApp {
    ...
    public void frontal(Image img, FaceAnnotation faceAnnotation) {
    ...
    private void writePolygonsDataQuads(Image img, FaceAnnotation face) {
    ...
    public static void main(String[] args) throws IOException, GeneralSecurityException {
        ...
        Image img = (Image)Image.getFromFile(inputPath.toFile());
        ...
        faces.forEach(faceAnnotation -> {
            ...
            app.writeFaceDataWithZ(img, faceAnnotation);
        });
    ...
    private void annotateWithFaces(Image img, FaceAnnotation faceAnnotation) {
    }
