...
class RunZBuffer(
    ...
    private val requestCode: Int = 13210390
            ...
            if (settings != null) {
                if (settings["useConstantMeshIncrement"] == null) {
                    ...
                    this.useConstantMeshIncrement =
                        settings["useConstantMeshIncrement"].toString().toBoolean()
                    this.minMeshIncrement = settings["minMeshIncrement"]?.toString()?.toIntOrNull() ?: 0
                    this.maxMeshIncrement = settings["maxMeshIncrement"]?.toString()?.toIntOrNull() ?: 0
                }
            }
...
*/
    ...
    fun processImage(): Image {
        ...
        if (model != null) {
            ...
            if (editData != null) {
                ...
                if (useConstantMeshIncrement) {
                    ...
                    Logger.getAnonymousLogger()
                        .info("MinMaxOptimium set " + v + " increment value constructor : " + v)
                }
        ...
        if (model != null) {
            ...
            val bitmap: BufferedImage = imageRes.bi
            ...
            val filename =
                "autosave_" + date + "_" + imageRes.width + "x" + imageRes.height + ".png"
            val saveImageToPicturesLegacy1: File? =
                saveImageToPicturesLegacy(bitmap, filename)

            finishing(imageRes,saveImageToPicturesLegacy1)
            /*
            ...
            val run : Array<Image> = morphing.run()
  */
            ...
            finishing(imageRenderedFailed(),  null)
    ...
    fun finishing(image: Image, file: File?) {
    }
