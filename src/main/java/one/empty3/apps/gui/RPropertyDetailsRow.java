...
import one.empty3.apps.gui.ObjectDescription;
...
public class RPropertyDetailsRow implements TableModel {
    ...
    public List<one.empty3.apps.gui.ObjectDetailDescription> objectDetailDescriptions = new ArrayList<>();
    ...
    public void initTable() {
        ...
        if (representable.declarations().size() > 0) {
            representable.declarations().forEach((s, structureMatrix) -> {
                ...
                if (structureMatrix.getDim() == 0) {
                    ...
                    objectDetailDescriptions.add(new one.empty3.apps.gui.ObjectDetailDescription(propName[0], propName[1],
        ...
        if (representable instanceof Scene || representable instanceof RepresentableConteneur) {
            ...
            objectDescriptions.forEach(objectDescription -> {
                ...
                if (value != null) {
                    objectDetailDescriptions.add(new one.empty3.apps.gui.ObjectDetailDescription(
    ...
    public void setValueAt(Object aValue, int rowIndex, int columnIndex) {
        if (rowIndex < objectDetailDescriptions.size() && rowIndex >= 0) {
            ...
            one.empty3.apps.gui.ObjectDetailDescription descr = objectDetailDescriptions.get(rowIndex);
