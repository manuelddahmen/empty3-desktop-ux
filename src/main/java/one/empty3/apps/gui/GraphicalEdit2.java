...
import one.empty3.apps.gui.RepresentableClassList;
...
public class GraphicalEdit2 {
    ...
    private one.empty3.apps.gui.UpdateViewMain panel;
    ...
    public void setMain(one.empty3.apps.gui.Main main) {
        this.main = main;
    }
    ...
    public one.empty3.apps.gui.UpdateViewMain getPanel() {
        return panel;
    }
    ...
    public void copy(Representable representable, Point3D translate) {
        ...
        try {
            ...
            one.empty3.apps.gui.ModelBrowser modelBrowser = new one.empty3.apps.gui.ModelBrowser(getMain().getUpdateView().getzRunner().getzBuffer(),
                    getMain().getDataModel().getScene(), Point3D.class);
            modelBrowser.getObjects().forEach(new Consumer<one.empty3.apps.gui.ModelBrowser.Cell>() {
                @Override
                public void accept(one.empty3.apps.gui.ModelBrowser.Cell cell) {
