...
public class RepresentableClassList {
    ...
    static one.empty3.apps.gui.MyObservableList<one.empty3.apps.gui.ObjectDescription>
            listClasses = new one.empty3.apps.gui.MyObservableList<>();
    ...
    public static void add(String name, Class clazz) {
        one.empty3.apps.gui.ObjectDescription objectDescription = new one.empty3.apps.gui.ObjectDescription();
        objectDescription.setName(name);
        objectDescription.setR(clazz);
        listClasses.add(objectDescription);
    }

    public static one.empty3.apps.gui.MyObservableList<one.empty3.apps.gui.ObjectDescription> myList(Object object) {
        return null;
    }

    public static one.empty3.apps.gui.MyObservableList<ObjectDescription> myList() {
