    ...
    private void initComponents() {
        ...
        //======== dialogPane ========
        {
            ...
            //======== contentPanel ========
            {
                ...
                this.labelClass.setBackground(new Color(Lumiere.getIntFromInts(51, 51, 255)));
                ...
                this.label1.setBackground(new Color(Lumiere.getIntFromInts(0, 51, 255)));
                ...
                this.label5.setBackground(new Color(Lumiere.getIntFromInts(0, 51, 255)));
