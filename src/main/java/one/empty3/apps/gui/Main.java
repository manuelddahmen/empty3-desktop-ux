...
public class Main implements PropertyChangeListener {
    ...
    private one.empty3.apps.gui.MyObservableList<Representable> translate;
    ...
    private one.empty3.apps.gui.MeshGEditorThread meshGeditorThread;
    private MeshGraphicalEdit graphicalEditMesh;
    one.empty3.apps.gui.MeshEditorBean meshEditorProps;
    ...
    public Main() {
        dataModel = new one.empty3.apps.gui.DataModel();
        initComponents();
        ...
        meshEditorProps = new one.empty3.apps.gui.MeshEditorBean();
        ...
        treeSelIn = new JList(new one.empty3.apps.gui.ListModelSelection(graphicalEdit2.getSelectionIn()));
        treeSelIn.setCellRenderer(new one.empty3.apps.gui.Rendu());
        ...
        meshGeditorThread = new one.empty3.apps.gui.MeshGEditorThread(this);
        meshGeditorThread.start();
    }

    private one.empty3.apps.gui.TextureEditor getTextureEditor() {
        return textureEditor1;
    }

    public one.empty3.apps.gui.DataModel getDataModel() {
        return dataModel;
    }

    public void setDataModel(one.empty3.apps.gui.DataModel dataModel) {
        this.dataModel = dataModel;
    }

    public one.empty3.apps.gui.UpdateViewMain getUpdateView() {
        return updateViewMain;
    }

    public void setUpdateView(one.empty3.apps.gui.UpdateViewMain updateView) {
        this.updateViewMain = updateView;
    }

    private one.empty3.apps.gui.DataModel dataModel;
    ...
    */
    ...
    public one.empty3.apps.gui.LoadSave getLoadSave() {
        return loadSave1;
    }

    public one.empty3.apps.gui.MyObservableList getMyObservableListSelIn() {
        return this.myObservableListSelIn;
    }

    public one.empty3.apps.gui.MyObservableList getMyObservableListSelOut() {
    ...
    private void initComponents() {
        ...
        this.updateViewMain = new one.empty3.apps.gui.UpdateViewMain();
        this.tabbedPane1 = new JTabbedPane();
        this.textureEditor1 = new one.empty3.apps.gui.TextureEditor();
        ...
        this.loadSave1 = new one.empty3.apps.gui.LoadSave();
        ...
        this.texturesDrawEditMapOnObjectPart1 = new one.empty3.apps.gui.TexturesDrawEditMapOnObjectPart();
        this.myObservableListSelIn = new one.empty3.apps.gui.MyObservableList();
        this.myObservableListSelOut = new one.empty3.apps.gui.MyObservableList();

        //======== MainWindow ========
        {
            this.MainWindow.setTitle("Empty3");
            this.MainWindow.setDefaultCloseOperation(WindowConstants.EXIT_ON_CLOSE);
            this.MainWindow.setBackground(new Color(Lumiere.getIntFromInts(204, 255, 255)));
            ...
            //======== panel6 ========
            {
                ...
                //======== panel5 ========
                {
                    ...
                    //======== panel4 ========
                    {
                        ...
                        //---- updateViewMain ----
                        this.updateViewMain.setBackground(new Color(Lumiere.getIntFromInts(204, 255, 204)));
    ...
    private one.empty3.apps.gui.MyObservableList myObservableListSelIn;
        ...
        if (evt.getPropertyName().equals("representable")) {
            ...
            if (evt.getNewValue() == null) {
                ...
                if (evt.getNewValue().equals(-1)) {
                    try {
                        this.getUpdateView().getzRunner().setLastImage(new Image(ImageIO.read(new File("resources/img/FAILED.PNG"))));
                    } catch (IOException e) {
                        e.printStackTrace();
                    }
                } else if (evt.getNewValue().equals(0)) {
                    try {
                        this.getUpdateView().getzRunner().setLastImage(new Image(ImageIO.read(new File("resources/img/WAITING.PNG"))));
                    } catch (IOException e) {
                        e.printStackTrace();
                    }
                }
    ...
    public one.empty3.apps.gui.MeshEditorBean getMeshEditorProps() {
