...
public class TestSoS extends TestObjetSub {
    ...
    public void ginit() {
        ...
        try {
            bufferedImageHeightMap = new Image(ImageIO.read(new File("res/img/gebco_08_rev_elev_21600x10800.png")));
            bufferedImageTexture = new Image(ImageIO.read(new File("res/img/planets/" + list[planetNo])));
            TextureImg textureImg = new TextureImg(new Image(bufferedImageTexture));
