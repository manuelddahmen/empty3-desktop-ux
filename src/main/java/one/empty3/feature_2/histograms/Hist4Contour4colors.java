...
public class Hist4Contour4colors extends ProcessFile {
    ...
    public boolean process(File in, File out) {
        ...
        try {
            //one.empty3.libs.Image.saveFile(outP.normalize(0, 1).getImage().getBitmap(), "jpg", out);
            outP.getImage2().saveFile(out);
            //one.empty3.libs.Image.saveFile(outP0.normalize(0, 1).getImage().getBitmap(), "jpg", out);
            return true;
