...
package one.empty3.feature_2.pio;
 ...
 */
    ...
    public boolean process(File in, File out) {
        ...
        try {
            ...
            //one.empty3.libs.Image.saveFile(pi.getImage().getBitmap(), "JPEG", out);
            ...
            //one.empty3.libs.Image.saveFile(m2g, "JPEG", new File(out.getParent()+5+"jpg"));
            return true;
        } catch (Exception ex) {
            ex.printStackTrace();
            return false;
